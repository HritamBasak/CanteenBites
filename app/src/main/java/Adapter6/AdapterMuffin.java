...
public class AdapterMuffin extends RecyclerView.Adapter<AdapterMuffin.ViewHolder>
{
    ...
    Context context;
    public AdapterMuffin(ArrayList<ModelRecipeDosa> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AdapterMuffin.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=View.inflate(context, R.layout.recyclerviewdosa,null);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterMuffin.ViewHolder holder, int position) {
