...
public class AdapterTea extends RecyclerView.Adapter<AdapterTea.ViewHolder>
{
    ...
    Context context;
    public AdapterTea(ArrayList<ModelRecipeDosa> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AdapterTea.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=View.inflate(context, R.layout.recyclerviewdosa,null);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterTea.ViewHolder holder, int position) {
