...
public class AdapterDonuts extends RecyclerView.Adapter<AdapterDonuts.ViewHolder>
{
    ...
    Context context;
    public AdapterDonuts(ArrayList<ModelRecipeDosa> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AdapterDonuts.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=View.inflate(context, R.layout.recyclerviewdosa,null);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterDonuts.ViewHolder holder, int position) {
